...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/intel-gmmlib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/intel-gmmlib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add intel-gmmlib
# for installing globally
pixi global install intel-gmmlib
```
...
It is possible to list all of the versions of `intel-gmmlib` available on your platform:
...
```
pixi search intel-gmmlib --channel conda-forge
```
